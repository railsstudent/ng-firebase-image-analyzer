...
4. For aesthetic adjustments, ensure all values are realistic: use 0.0-3.0 normalized coordinates for cropping, multipliers (where 1.0 is neutral) for exposure/color, and 0.0-1.0 for warmth.`;
